...
@Component({
    ...
    <section id="experience" class="section exp-section" aria-labelledby="exp-heading">
      <div class="container">
        ...
        <div class="section-header reveal">
          ...
          <p>A focused, high-impact career building enterprise products that serve thousands of users globally.</p>
        </div>
        ...
        <div class="exp-layout">
          ...
          <div class="exp-list">
            @for (exp of data.experiences; track exp.id; let i = $index) {
              <article class="exp-card reveal" [style.transition-delay]="(i * 0.15) + 's'"
            ...
            <div class="future-card reveal">
              ...
              <div class="future-card-inner glass">
                <h4>Next Chapter</h4>
                <p>Always open to exciting opportunities that challenge and inspire. Let's build something great together.</p>
                <button class="btn-contact" (click)="scrollTo('contact')">
                  Get In Touch →
                </button>
              </div>
            </div>
  ...
  styles: [`
    ...
    .timeline-track {
      ...
      width:2px;
      position:relative;
      @media(max-width:768px){width:1px;}
    }
    .timeline-line {
      position:sticky;
      top:80px;
      ...
      background:linear-gradient(180deg,#FF6B00 0%,rgba(255,107,0,.2) 60%,transparent 100%);
      border-radius:2px;
    }

    .exp-list { flex:1;display:flex;flex-direction:column;gap:32px; }
    ...
    .timeline-dot {
      ...
      box-shadow:0 0 16px rgba(255,107,0,.5);
      z-index:2;
      @media(max-width:768px){left:-29px;}

      &.current {
        width:20px;height:20px;
        left:-51px;
        box-shadow:0 0 0 4px rgba(255,107,0,.2),0 0 24px rgba(255,107,0,.6);
      }
    }
    .dot-pulse {
    ...
    .future-dot {
      background:#1A1A1A;border:2px solid rgba(255,255,255,.12);
      box-shadow:none;display:flex;align-items:center;justify-content:center;
      font-size:.7rem;color:#505050;
    }
    ...
    .exp-card-inner {
      ...
      &:hover { border-color:rgba(255,107,0,.2);box-shadow:0 8px 40px rgba(0,0,0,.4); }
    ...
    .exp-company-block { display:flex;align-items:center;gap:14px; }
    .company-logo {
    ...
    .company-name {
      font-family:'Space Grotesk',sans-serif;font-size:1.125rem;font-weight:700;
      color:#fff;margin:0 0 4px;
    }
    .exp-location {
      display:flex;align-items:center;gap:4px;
      font-size:.8rem;color:#505050;
    }
    .exp-meta-right { display:flex;flex-direction:column;align-items:flex-end;gap:8px; }
    .exp-period {
      font-family:'JetBrains Mono',monospace;font-size:.8rem;color:#707070;
    ...
    .role-title {
      ...
      color:#FF8C42;margin:0 0 8px;
    }
    .role-desc { font-size:.9375rem;color:#707070;line-height:1.7;margin:0; }

    .resp-heading {
      font-family:'Space Grotesk',sans-serif;font-size:.7rem;font-weight:600;
      text-transform:uppercase;letter-spacing:.08em;color:#505050;
      margin:0 0 14px;
    }
    .resp-list {
    ...
    .resp-list li {
      ...
      font-size:.875rem;color:#707070;line-height:1.6;
    }
    .resp-bullet { color:#FF6B00;font-weight:700;flex-shrink:0;margin-top:1px; }
    ...
    .future-card-inner {
      ...
      h4{font-size:1rem;color:#505050;margin:0 0 8px;font-family:'Space Grotesk',sans-serif;}
      p{font-size:.875rem;color:#404040;margin:0 0 16px;line-height:1.7;}
    }
    .btn-contact {
      background:none;border:none;color:#FF8C42;font-size:.875rem;font-weight:600;
      cursor:pointer;padding:0;transition:color .2s ease;
      &:hover{color:#FF6B00;}
    }

    /* Reveal */
    .reveal { opacity:0;transform:translateX(-24px);transition:opacity .7s ease,transform .7s ease; }
  ...
  ngAfterViewInit(): void {
    ...
    const observer = new IntersectionObserver(
      (entries) => {
        entries.forEach(e => {
          if (e.isIntersecting) {
            document.querySelectorAll('#experience .reveal').forEach(el => el.classList.add('revealed'));
            observer.disconnect();
          }
        });
      },
