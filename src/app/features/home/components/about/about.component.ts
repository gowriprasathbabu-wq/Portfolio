        ...
        <div class="about-grid">
          ...
          <div class="about-right">
            ...
            <h2 id="about-heading" class="about-heading reveal delay-2">
              Building <span class="gradient-text">enterprise</span> solutions<br />that scale
              globally
            </h2>
            ...
            <p class="about-detail reveal delay-4">
              With a deep focus on <strong>clean architecture</strong> and
              <strong>SOLID principles</strong>, I craft maintainable, testable, and performant
              applications. From architecting multi-country procurement platforms to integrating
              AI-powered workflows, I bring a full-stack perspective to every challenge.
            </p>
              ...
              @for (skill of data.coreSkills; track skill.label) {
                <div class="skill-row">
                  ...
                  <div class="skill-track">
                    <div class="skill-fill" #skillFill [attr.data-width]="skill.percentage"></div>
                  </div>
                </div>
              }
            </div>
