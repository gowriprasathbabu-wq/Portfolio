      ...
      <div class="container hero-inner">
        ...
        <div class="hero-content">
          ...
          <h1 class="hero-name reveal delay-2">
            <span class="name-line gradient-text font-set"
              >Gowri Prasath <span class="name-line gradient-text">Babu</span></span
            >
          </h1>

          <!-- Title -->
          <p class="hero-title reveal delay-3">Senior Software Engineer</p>
          ...
          <p class="hero-description reveal delay-5">
            ...
            <strong>Angular 20</strong>, <strong>ASP.NET Core</strong>, and <strong>AWS</strong>. 5+
            years building scalable solutions for global teams.
          </p>

          <!-- Meta chips -->
          <div class="hero-meta reveal delay-6">
            <span class="meta-chip"> <span>📍</span> Coimbatore, India </span>
            <span class="meta-chip"> <span>⚡</span> 5+ Years Exp </span>
            <span class="meta-chip"> <span>🌍</span> 10+ Countries </span>
          </div>

          <!-- CTA buttons -->
          <div class="hero-actions reveal delay-7">
            <a
              href="/assets/resume/Gowri Prasath Babu - Software Developer.pdf"
              download
            ...
            <button class="btn btn-ghost btn-lg" (click)="scrollTo('contact')">Contact Me</button>
          </div>
            ...
            <div class="avatar-frame">
              <div class="avatar-inner">
                ...
                <svg
                  viewBox="0 0 200 200"
                  class="avatar-svg"
                  aria-label="Gowri Prasath Babu avatar"
                >
                  <defs>
