    ...
    <section id="certifications" class="section cert-section" aria-labelledby="cert-heading">
      <div class="container">
        <div class="section-header reveal">
          ...
          <p>
            Committed to continuous learning and professional development in cloud, DevOps, and
        ...
        <div class="cert-grid">
          ...
          <!-- Add more card -->
          <div
            class="cert-add-card reveal glass"
            [style.transition-delay]="data.certifications.length * 0.1 + 's'"
          >
  ...
  readonly learningPath = [
    {
      ...
      desc: 'Deep mastery of Angular 20 with Signals API, SSR, Standalone components.',
      done: true,
      active: false,
    },
    {
      label: 'ASP.NET Core & C#',
      desc: 'Enterprise REST APIs with clean architecture and EF Core ORM.',
      done: true,
      active: false,
    },
    {
      label: 'AWS Cloud Practitioner',
      desc: 'EC2, ECS, EKS, ELB, S3, IAM — production deployments in use.',
      done: true,
      active: false,
    },
    {
      label: 'Angular Certification',
      desc: 'Professional certification from the Angular team currently in progress.',
      done: false,
      active: true,
    },
    {
      label: 'AWS Developer Associate',
      desc: 'Advancing cloud skills with developer-focused AWS certification.',
      done: false,
      active: false,
    },
    {
      label: 'Kubernetes (CKAD)',
      desc: 'Certified Kubernetes Application Developer for container orchestration.',
      done: false,
      active: false,
    },
  ];
    ...
    const observer = new IntersectionObserver(
      (entries) => {
        entries.forEach((e) => {
          if (e.isIntersecting) {
            document
              .querySelectorAll('#certifications .reveal')
