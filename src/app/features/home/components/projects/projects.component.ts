    ...
    <section id="projects" class="section projects-section" aria-labelledby="projects-heading">
      <div class="container">
        <div class="section-header reveal">
          ...
          <p>
            Enterprise-grade solutions built for real-world impact — from global procurement
        ...
        <div class="grid-projects">
          @for (project of gridProjects(); track project.id; let i = $index) {
            <article
              class="project-mini-card reveal glass"
              [style.transition-delay]="i * 0.1 + 's'"
            >
...
export class ProjectsComponent implements AfterViewInit {
  ...
  protected featuredProjects = computed(() => {
    ...
    return this.data.projects.filter((p) => {
      ...
      if (f === 'dotnet')
        return p.featured && (techStr.includes('.net') || techStr.includes('asp'));
